			...
			<div className="entry-block">
				<div className="row">
					<label className="col-5">
						...
						<input className="col-6" type="number" name="total_slots" onChange={this.changeHandler} value={this.props.total_slots} />
					</label>
					<label className="col-4">
						<span className="col-6">Initial Cars </span>
						<input type="number" className="col-6" name="filled" onChange={this.changeHandler} value={this.props.filled } />
					</label>
					<div className="col-3">
